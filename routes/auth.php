...
// Affaliate password generate
Route::get('affiliates/generate-password/{token}', [AffiliateController::class, 'getGeneratePassword']);
Route::post('affiliates/update-password', [AffiliateController::class, 'updatePassword'])->name('affiliates.updatePassword');
