...
if (!class_exists('CreateAffiliateIdmetrixTable')) {
    class CreateAffiliateIdmetrixTable extends Migration
    {
        ...
        public function up()
        {
            ...
            Schema::create('affiliate_idmetrix', function (Blueprint $table) {
                $table->increments('id');
        ...
        {
            Schema::dropIfExists('affiliate_idmetrix');
        }
    }
}
