...
class CreateSaleProductsEnergiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sale_products_energy', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sale_products_energies');
    }
}
