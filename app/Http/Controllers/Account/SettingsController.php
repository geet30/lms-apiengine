...
class SettingsController extends Controller
{
    ...
    public function update(SettingsInfoRequest $request)
    {
        ...
        $validated['first_name'] = encryptGdprData(strtolower($request->first_name));
        $validated['last_name'] = encryptGdprData(strtolower($request->last_name));
    ...
    public function changeEmail(SettingsEmailRequest $request)
    {
        ...
        if ($request->input('current_email') === encryptGdprData('demo@demo.com')) {
            return redirect()->intended('account/settings');
        }

        auth()->user()->update(['email' => encryptGdprData($request->input('email'))]);
