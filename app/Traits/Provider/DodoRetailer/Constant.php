...
trait Constant
{
    public $dodopostalFields = [
        'SiteUnitNumber'=>'unit_number',
        'SiteUnitType'=>'unit_type',
        'SiteFloorNo'=>'floor_no',
        'SiteFloorTypeCode' => 'floor_type_code',
        'SiteSiteDescriptor' => 'site_descriptor',
        // 'siteFloorLevelType'=>'floor_level_type',
        'SiteStreetName' => 'street_name',
        'SiteStreetNumber'=>'street_number',
        'SiteStreetCode' => 'street_code',
    ...
    public $dodoBillingpostalFields = [
