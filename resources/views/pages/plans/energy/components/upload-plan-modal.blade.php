...
<div class="modal fade"  data-bs-backdrop="static" data-bs-keyboard="false" id="upload_plan_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y">
                <!--begin::Form-->
                <form id="add_plan_form" class="form">
