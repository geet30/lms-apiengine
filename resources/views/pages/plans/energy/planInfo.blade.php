        ...
        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
            ...
            <div class="me-7 mb-4">
                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                    <img src=" https://devcore02.cimet.io/uploads/providers_logo/5_EnergyAustralia.png" alt="image">
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <a href="#" class="btn btn-sm btn-light-success fw-bolder ms-2 fs-8 py-1 px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Upgrade
                                to Pro</a>
                        </div>
                    ...
                    <div class="d-flex my-4">
                        <a href="#" class="btn btn-sm btn-light me-2" id="kt_user_follow_button">
                            ...
                            <span class="svg-icon svg-icon-3 d-none"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <a href="#" class="btn btn-sm btn-primary me-3" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-trigger="hover" title="" data-bs-original-title="Coming soon">Hire Me</a>
                        ...
                        <div class="me-0">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-trigger="hover" title="" data-bs-original-title="Coming soon">
                                ...
                                <div class="menu-item px-3" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-trigger="hover" title="" data-bs-original-title="Coming soon">
                                    <a href="#" class="menu-link px-3">
                                ...
                                <div class="menu-item px-3 my-1">
                                    <a href="http://127.0.0.1:8000/account/settings" class="menu-link px-3">
                                        Settings
                                    </a>
                                </div>
                ...
                <div class="d-flex flex-wrap flex-stack">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="4500" data-kt-countup-prefix="$">$4,500
                                    </div>
                                </div>
                    ...
                    <div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                        ...
                        <div class="h-5px mx-3 w-100 bg-light mb-3">
                            <div role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" class="bg-success rounded h-5px page_speed_333834330"></div>
                        </div>
                    </div>
