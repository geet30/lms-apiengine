			...
			<table class="table border table-hover table-row-dashed align-middle fs-7 gy-2 gs-4 dt-bootstrap all-table-css-class" id="lead_data_table">
				...
				<thead>
					...
					<tr class="text-start text-gray-400 fw-bolder fs-7 gs-0">
						...
						<th class="min-w-100px text-capitalize text-nowrap">{{__('plans/mobile.phone_brand')}}</th>
				...
				<!--end::Table head-->
				<!--begin::Table body-->
				<tbody class="fw-bold text-gray-600 handset_table_body">
				<?php $inc = 1; ?>
							...
							<td>
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
									...
									<div class="menu-item px-3">
										<a href="{{ theme()->getPageUrl('provider/plans/mobile/'.encryptGdprData($providerId).'/manage-phone/'.encryptGdprData($planId).'/manage-phone-variant/'.encryptGdprData($row->handset_id)) }}" class="menu-link px-3">{{__('plans/mobile.manage_variant')}}</a>
									</div>
								</div>
							</td>
							</tr>
