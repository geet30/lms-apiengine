	...
	<!--begin::Card title-->
		...
		<div class="card-toolbar">
			...
			<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
				...
				<a class="btn btn-light-primary me-3 assign_handsets" data-bs-toggle="modal" data-bs-target="#assign_phone_modal">
				<span class="svg-icon svg-icon-2">
					<i class="fa fa-plus" aria-hidden="true"></i></span>{{__('plans/mobile.assign_phone')}}
				</a>
			</div> 
		</div> 
	</div>
