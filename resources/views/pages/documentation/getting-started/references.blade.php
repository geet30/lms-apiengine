            ...
            <div class="table-responsive border rounded">
                <table class="table table-striped table-flush align-middle mb-0">
                    ...
                    <tr class="fs-4 fw-bolder text-dark p-6">
                        <th class="min-w-400px text-capitalize text-nowrap">Name</th>
                        <th class="min-w-400px text-capitalize text-nowrap">Link</th>
                        <th class="min-w-100px text-capitalize text-nowrap">Version</th>
                    </tr>
                    </thead>
                    <tbody>
