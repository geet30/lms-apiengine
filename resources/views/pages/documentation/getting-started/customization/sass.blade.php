<x-base-layout>
    ...
    <div class="py-10">
        ...
        <!--begin::Block-->
        <div class="py-5">
            Components folder in <code>/resources/assets/[demo]/sass/components/</code> contains SASS code that customizes the core Bootstrap components to match the <strong>{{ theme()->getProductName() }}</strong>'s own design system
            and custom components. Both {!! theme()->getProductNameHtml() !!} and <strong>Bootstrap</strong>&nbsp; components are customized in <code>/resources/assets/[demo]/sass/_variables.scss</code>.
        </div>
        <!--end::Block-->
    </div>
    <!--end::Section-->
    ...
    <div class="py-10">
        ...
        <!--begin::Block-->
        <div class="py-5">
            In <code>/resources/assets/[demo]/sass/_variables.scss</code> file, {!! theme()->getProductNameHtml() !!} deeply customizes the standard <strong>Bootstrap</strong>&nbsp; components by
    ...
    <div class="py-10">
        ...
        <!--begin::Block-->
        <div class="py-5">
            Layout related SASS code is located in <code>/resources/assets/[demo]/sass/layout/</code> folder. This folder contains the layout's markup and SASS variables files as explained in the below table:
        </div>
        <!--end::Block-->
            ...
            <div class="table-responsive border rounded">
                <table class="table table-striped table-flush align-middle mb-0">
                    ...
                    <tr class="fs-4 fw-bolder text-dark p-6">
                        <th class="min-w-200px text-capitalize text-nowrap">File</th>
                        <th class="min-w-400px text-capitalize text-nowrap">Description</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr class="p-6">
    ...
    <div class="pt-10">
        ...
        <!--begin::Block-->
        <ul class="py-5">
            <li class="py-3">{!! theme()->getProductNameHtml() !!} compiles layout, components(including the Bootstrap & custom components) into the main bundle: <code>/public/[demo]/css/style.bundle.css</code>.</li>
            <li class="py-3">The custom SASS files are compiled separately into CSS folder: <code>/public/[demo]/css/custom</code></li>
            <li class="py-3">All 3rd-party plugins css files are bundled into the plugins bundle CSS file and globally included in all pages. <code>/public/[demo]/plugins/global/plugins.bundle.css</code>.</li>
        </ul>
        <!--end::Block-->
    </div>
    <!--end::Section-->
