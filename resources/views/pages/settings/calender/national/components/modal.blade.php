<div class="modal fade" id="national_holiday_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog mw-650px">
        <div class="modal-content">
            <div class="modal-header bg-primary px-5 py-4">
                <h2 class="fw-bolder fs-12 text-white national_holiday_title"></h2>
            ...
            <div class="modal-body px-5">
                <form role="form" name="add_national_holiday" id="add_national_holiday">
                    @csrf
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                ...
                <button type="button" class="submit_button" class="btn btn-primary national_holday_submit_btn"></button>
            </div>
        </div>
