<x-base-layout>
    ...
    <div class="gy-12 gx-xl-12 card mt-0 mx-0 px-8 all-table-title-css">
        {{ theme()->getView('pages/settings/master-tariff-codes/components/toolbar', ['distributors' => $distributors]) }}
        {{ theme()->getView('pages/settings/master-tariff-codes/components/table') }}
    </div>
    {{ theme()->getView('pages/settings/master-tariff-codes/components/modal', ['distributors' => $distributors]) }}
    <!--end::Row-->
    @section('styles')
    ...
    @section('scripts')
        ...
        @include('pages.settings.master-tariff-codes.components.js');
