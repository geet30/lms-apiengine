...
<div class="modal fade" id="upload_tariff_code_file_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <!--begin::Modal dialog-->
    ...
    <div class="modal-dialog modal-dialog mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder"> {{ __('plans/energyPlans.import_demand_tariff_rate_head') }} </h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="demad_tariff_form" class="form">
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="fs-5 fw-bold form-label mb-5">{{ __('plans/energyPlans.upload_file') }}: </label>
                        <input type = "file" class="form-control" rows="3" name="tariff_code_file" >
                        <span class="error text-danger tariff_code_file_error"></span>
                    </div>
...
<!--begin::Modal - Adjust Balance-->
<div class="modal fade" id="error-demand-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
