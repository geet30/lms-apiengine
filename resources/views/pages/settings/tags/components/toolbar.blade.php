...
<div class="card-header border-0 pt-0 px-0">
    <div class="card-title">
        <form id="tag_filters" name="tag_filters" accept-charset="UTF-8" class="tag_filters">
            <div class="d-flex align-items-center position-relative gap-5 my-1">
                ...
                <button type="button" class="btn btn-light btn-active-light-primary me-2 resetbutton">Reset</button>
                <button type="submit" class="btn btn-primary" id="apply_tag_filters">Apply</button>
            </div>
    ...
    <div class="card-toolbar flex-row-fluid justify-content-end">
        ...
        <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-light-primary me-3 add-button" data-bs-toggle="modal"
                    data-bs-target="#addtagmodal" data-count=5>+Add</button>
