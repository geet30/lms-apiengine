...
<div class="card-header align-items-center py-0 gap-2 gap-md-5 px-0 border-0">
    ...
    <div class="card-toolbar">
        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
            <form role="form" name="{{isset($info) && $info=='sub-affiliates' ?'subaffiliate_filters':'affiliate_filters'}}" id="affiliate_filters" class="affiliate_filters">
                @csrf
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4 gap-2 gap-md-5">
                        <div class="input-group w-275px">
                            <div class="d-flex justify-content-end">
                                <button type="button" class="btn btn-light btn-active-light-primary me-2 resetbutton" data-kt-menu-dismiss="true" data-kt-customer-table-filter="reset" data-id="{{isset($info) && $info =='sub-affiliates'?request()->segment(3):''}}">Reset</button>
