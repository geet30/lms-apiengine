<div class="d-flex align-items-top position-relative gap-5 my-1">
    ...
    <div class="col-lg-3 px-12" style="text-align:right;"> 
        <button type="button" class="btn btn-primary add-user" data-bs-toggle="modal" data-bs-target="#add_user_form_modal">+ Add</button>
    </div>
</div>
...
<div class="modal fade" id="add_user_form_modal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog mw-650px">
        <div class="modal-content">
            <form id="add_affiliate_bdm_form" class="form">
                <div class="modal-header" id="">
                    <h2 class="fw-bolder title add_edit_affilite_bdm_title">Add Affiliate BDM</h2>
