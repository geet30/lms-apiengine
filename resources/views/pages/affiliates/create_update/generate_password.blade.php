<x-auth-layout>
    ...
    <form method="POST" action="{{route('affiliates.updatePassword')}}" class="form w-100" novalidate="novalidate" id="kt_new_password_form">
        @csrf
        ...
        <div class="fv-row mb-10">
            ...
            <input class="form-control form-control-solid" type="email" name="email" autocomplete="off" value="{{ old('email', decryptGdprData($user->email)) }}" required/>
        </div>
        <!--end::Input group-->
    ...
    @section('scripts')
{{--        <script src="{{'common/js/custom/authentication/password-reset/new-password.js' }}" type="application/javascript"></script>--}}
    @endsection
