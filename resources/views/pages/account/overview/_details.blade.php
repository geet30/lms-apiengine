    ...
    <div class="card-body p-9">
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-8 fv-row">
                <span class="fw-bold fs-6">{{ isset($info) ? $info->company : '-' }}</span>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-8 d-flex align-items-center">
                <span class="fw-bolder fs-6 me-2">{{ isset($info) ? $info->phone : '-' }}</span>

                @if(isset($info) && $info->phone)
        ...
        <div class="row mb-7">
            ...
            <!--begin::Col-->
            <div class="col-lg-8">
                <a href="#" class="fw-bold fs-6 text-dark text-hover-primary">{{ isset($info) ? $info->website : '-'}}</a>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-8">
                <span class="fw-bolder fs-6 text-dark">
                    {{ (isset($info) && $info->country) ? collect(\App\Core\Data::getCountriesList())->get($info->country)['name'] : '-' }}
                </span>
            </div>
            <!--end::Col-->
        </div>
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-8">
                <span class="fw-bolder fs-6 text-dark">
                    @if(isset($info) && $info->communication)
