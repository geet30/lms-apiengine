...
<div class="card-body pt-0 table-responsive " id="">
    <table class="table border table-hover align-middle table-row-dashed fs-7 gy-2 gs-4 all-table-css-class" id="ram_table">
        <thead>
            <tr class="fw-bolder fs-7 text-gray-800 px-7">

                <th class="text-capitalize text-nowrap">Sr.No</th>
                <th class="text-capitalize">Unit</th>
                <th class="text-capitalize">Capacity</th>
				<th class="text-capitalize">Status</th>
                <th class="text-capitalize">Actions</th>
            </tr>
        </thead>
		@include('pages.mobilesettings.handsets.ram.components.filtertable')
