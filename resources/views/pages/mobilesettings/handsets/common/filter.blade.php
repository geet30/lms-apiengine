<div class="card-header align-items-center border-0">
    ...
    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
        @if(isset($phonesTab) && $phonesTab=='yes')
            <button type="button" class="btn btn-light-primary filter_leads collapsible collapsed me-3" data-bs-toggle="modal"  id="add_provider">+Provider</button>
        @endif
      

        <button type="button" class="btn btn-light-primary collapsible collapsed me-3 add_handsets" id="add_handsets" data-bs-toggle="modal"  data-bs-target="{{ (isset($modal_id)) ? $modal_id:'' }}" >+Add</button>
