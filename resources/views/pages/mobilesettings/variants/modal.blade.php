<div class="modal fade" id="imagemodal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: fit-content;">
        <div class="modal-content">
            <img src="" class="img_src">
        </div>
    </div>
</div>

<div class="modal fade" id="assign_variant_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
                        ...
                        <div class="row mb-4">
                            <div class="col-md-3">
                                ...
                                <select class="form-select mb-2 provider-list h-50px border" id="assign_provider_drop_down" data-control="select2" data-hide-search="true" data-placeholder="Provider" data-arial="Provider">
                                    ...
                                    <option value="{{encryptGdprData($provider->user_id)}}">{{decryptGdprData($provider->legal_name)}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
