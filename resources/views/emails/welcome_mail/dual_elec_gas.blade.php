  ...
  <tbody>
    <tr>
      ...
      <td align="right" style="font-size:16px; font-family: 'Muli', sans-serif; line-height:20px; font-weight:700; color:#2f3c3b;">Flick the switch! <br><span style="color:#e73534">Save on energy bills now.</span></td>
        ...
        <h2 style=" color:#2f3c3b; font-size:36px; margin:15px 0; line-height:44px;  text-align:left; font-family: 'Muli', sans-serif;  font-weight:800">Dear {{ $visitor['first_name'] }},</h2>
          </td>
          </tr>
          <tr>
          ...
          <p>Thanks for choosing {{ $affiliate['legal_name'] }} to arrange your electricity and gas connection with 
{{ $mail_content['electricity_provider_name'] }}.</p>
          ...
          <td style="padding:10px; border-top:1px solid #cccc; font-family: 'Muli', sans-serif;font-size:16px; font-weight:400; color:#2f3c3b; line-height:24px;">{{ $mail_content['electricity_phone_number'] }}</td>
           ...
           <tr>
          <td style="padding:10px; font-weight:bold; border-top:1px solid #cccc; font-family: 'Muli', sans-serif; border-right:1px solid #ccc;font-size:16px; font-weight:400; color:#2f3c3b; line-height:24px;">Electricity Plan Name:</td>
...
address or nominated email address.
          ...
          <td style="font-size:16px; text-align:left;  padding-bottom:20px; color:#2f3c3b; font-family: 'Muli', sans-serif;" colspan="2" ><p style="width:100%; float:right; margin-top:0; font-size:16px; font-weight:400; color:#2f3c3b; line-height:24px;">Once your application has been approved, you have a 10 business day cooling-off period if
you change your mind. If you wish to cancel your connection request you will need to
contact {{ $mail_content['electricity_provider_name'] }} directly on 
{{ $mail_content['electricity_provider_name'] }} phone number.
</p></td>
          </tr>
...
cannot change any details once your request has been sent.
          ...
          <td style="font-size:16px; text-align:left;  padding-bottom:20px; color:#2f3c3b;font-family: 'Muli', sans-serif;" colspan="2" ><p style="width:100%; float:right; margin-top:0; font-weight:bold"><strong>If you are transferring from another retailer</strong>
</p></td>
          </tr>
...
to transfer your electricity account so this may happen much faster.
          ...
          <td style="font-size:16px; text-align:left;  padding-bottom:20px; color:#2f3c3b;font-family: 'Muli', sans-serif;" colspan="2" ><p style="width:100%; float:right; margin-top:0; font-weight:bold"><strong>If you are moving property:</strong>
</p></td>
          </tr>
...
property and that you would like the electricity &amp; gas to be disconnected.
          ...
          <td style="font-size:16px; text-align:left;  padding-bottom:20px; color:#2f3c3b; font-family: 'Muli', sans-serif;border-bottom:1px solid #CFCFCF;" colspan="2" ><p style="width:100%; float:right; margin-top:0; font-size:16px; font-weight:400; color:#2f3c3b; line-height:24px;">The new connection may be done any time up until midnight on the day of transfer. As such,
