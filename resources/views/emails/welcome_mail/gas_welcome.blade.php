    ...
    <tr>
     ...
     <td align="right" style="font-size:16px; font-family: 'Muli', sans-serif; line-height:20px; font-weight:700; color:#2f3c3b;">Flick the switch! <br><span style="color:#e73534">Save on energy bills now.</span></td>
        ...
        <h2 style=" color:#2f3c3b; font-size:36px; margin:15px 0; font-family: 'Muli', sans-serif; line-height:44px;  text-align:left; font-weight:800">Dear {{ $visitor['first_name'] }},</h2>
          ...
          <p>Thanks for choosing {{ $affiliate['legal_name'] }} to arrange your gas connection with 
{{ $mail_content['gas_provider_name'] }}.</p>
          ...
          Below are the details of your gas connection:
          </td>
          </tr>
          
          <tr>
          <td style="padding:10px; font-weight:bold; font-family: 'Muli', sans-serif; border-top:1px solid #cccc; border-right:1px solid #ccc; font-size:16px; font-weight:400; color:#2f3c3b; line-height:24px;">Name:</td>
          ...
          <td style="padding:10px; border-top:1px solid #cccc; font-family: 'Muli', sans-serif;font-size:16px; font-weight:400; color:#2f3c3b; line-height:24px;">
                    ...
                    <a href="{{ url('/provider-term-conditions/'.$mail_content['gas_id']) }}"> Terms and Conditions</a>
                  </td>
          </tr>
...
address or nominated email address.
          ...
          <td style="font-size:16px; text-align:left;  padding-bottom:20px; color:#2f3c3b;" colspan="2" ><p style="width:100%; float:right; margin-top:0; font-family: 'Muli', sans-serif;">Once your application has been approved, you have a 10 business day cooling-off period if
you change your mind. If you wish to cancel your connection request you will need to
contact {{ $mail_content['gas_provider_name'] }} directly on 
{{ $mail_content['gas_provider_name'] }} phone number.
</p></td>
          </tr>
          
           <tr>
          
          <td style="font-size:16px; text-align:left;  padding-bottom:20px; color:#2f3c3b;" colspan="2" ><p style="width:100%; float:right; margin-top:0; font-family: 'Muli', sans-serif; font-size:16px; font-weight:400; color:#2f3c3b; line-height:24px;">If there are any issues with your application, {{ $mail_content['gas_provider_name'] }} may contact you directly.
</p></td>
          </tr>
...
about your connections you will need to contact {{ $mail_content['gas_provider_name'] }} directly on 
{{ $mail_content['gas_phone_number'] }}
. Unfortunately, we
cannot change any details once your request has been sent.
          ...
          <td style="font-size:16px; text-align:left;  padding-bottom:20px; color:#2f3c3b;" colspan="2" ><p style="font-family: 'Muli', sans-serif;width:100%; float:right; margin-top:0; font-weight:bold"><strong>If you are transferring from another retailer</strong>
</p></td>
          </tr>
...
your bill will come from {{ $mail_content['gas_provider_name'] }}.
</p></td>
          </tr>
           <tr>
          
          <td style="font-size:16px; text-align:left;  padding-bottom:20px; color:#2f3c3b;" colspan="2" ><p style="width:100%; font-family: 'Muli', sans-serif; float:right; margin-top:0; font-size:16px; font-weight:400; color:#2f3c3b; line-height:24px;">Your account will be transferred on or before your next scheduled meter read. Depending
...
property and that you would like the gas to be disconnected.
</p></td>
          </tr>
...
if you need the connection to be done early in the day, we recommend you speak to {{ $mail_content['gas_provider_name'] }}
