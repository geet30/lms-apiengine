            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="fw-bolder text-muted">
                        ...
                        <th class="min-w-150px text-capitalize text-nowrap">Authors</th>
                        <th class="min-w-140px text-capitalize text-nowrap">Company</th>
                        <th class="min-w-120px text-capitalize text-nowrap">Progress</th>
