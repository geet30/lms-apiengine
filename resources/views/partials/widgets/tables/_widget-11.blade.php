            ...
            <table class="table align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="fw-bolder text-muted bg-light">
                        <th class="ps-4 min-w-325px rounded-start text-capitalize text-nowrap">Product</th>
                        <th class="min-w-125px text-capitalize text-nowrap">Price</th>
                        <th class="min-w-125px text-capitalize text-nowrap">Deposit</th>
                        <th class="min-w-200px text-capitalize text-nowrap">Agent</th>
                        <th class="min-w-150px text-capitalize text-nowrap">Status</th>
