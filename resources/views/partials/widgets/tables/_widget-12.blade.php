            ...
            <table class="table align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="fw-bolder text-muted bg-light">
                        <th class="ps-4 min-w-300px rounded-start text-capitalize text-nowrap">Agent</th>
                        <th class="min-w-125px text-capitalize text-nowrap">Earnings</th>
                        <th class="min-w-125px text-capitalize text-nowrap">Comission</th>
                        <th class="min-w-200px text-capitalize text-nowrap">Company</th>
                        <th class="min-w-150px text-capitalize text-nowrap">Rating</th>
                        <th class="min-w-200px text-end rounded-end text-capitalize text-nowrap"></th>
                    </tr>
                </thead>
                <!--end::Table head-->
