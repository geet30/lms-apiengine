            ...
            <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                ...
                <thead>
                    <tr class="fw-bolder text-muted">
                        ...
                        <th class="min-w-150px text-capitalize text-nowrap">Order Id</th>
                        <th class="min-w-140px text-capitalize text-nowrap">Country</th>
                        <th class="min-w-120px text-capitalize text-nowrap">Date</th>
                        <th class="min-w-120px text-capitalize text-nowrap">Company</th>
                        <th class="min-w-120px text-capitalize text-nowrap">Total</th>
                        <th class="min-w-120px text-capitalize text-nowrap">Status</th>
                        <th class="min-w-100px text-end text-capitalize text-nowrap">Actions</th>
                    </tr>
                </thead>
                <!--end::Table head-->
